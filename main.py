...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        player_walk_1 = pygame.image.load('pygame tutorial/graphics/player/player_walk_1.png').convert_alpha()
        player_walk_2 = pygame.image.load('pygame tutorial/graphics/player/player_walk_2.png').convert_alpha()
        self.player_walk = [player_walk_1, player_walk_2]
        self.player_index = 0
        self.player_jump = pygame.image.load('pygame tutorial/graphics/player/jump.png').convert_alpha()

        self.image = self.player_walk[self.player_index]
        self.rect = self.image.get_rect(midbottom = (80,300))
        self.gravity = 0

        self.jump_sound = pygame.mixer.Sound('pygame tutorial/audio/jump.mp3')
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, type):
        ...
        if type == 'snail':
            snail_1 = pygame.image.load('pygame tutorial/graphics/enemy/snail1.png').convert_alpha()
            snail_2 = pygame.image.load('pygame tutorial/graphics/enemy/snail2.png').convert_alpha()
            self.frames = [snail_1, snail_2]
            y_pos = 300

        else:
            fly_1 = pygame.image.load('pygame tutorial/graphics/enemy/Fly1.png').convert_alpha()
            fly_2 = pygame.image.load('pygame tutorial/graphics/enemy/Fly2.png').convert_alpha()
...
start_time = 0
score = 0
bg_music = pygame.mixer.Sound('pygame tutorial/audio/music.wav')
